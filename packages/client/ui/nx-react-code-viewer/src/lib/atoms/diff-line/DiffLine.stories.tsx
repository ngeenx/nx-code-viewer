...
import type { DiffLine as DiffLineType } from '@ngeenx/nx-code-viewer-utils';

const createLine = (type: DiffLineType['type'], content: string, oldLineNumber?: number, newLineNumber?: number, highlightedContent?: string): DiffLineType =>
