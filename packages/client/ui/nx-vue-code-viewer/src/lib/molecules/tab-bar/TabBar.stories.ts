...
const manyTabs: MultiCodeViewerTabItem[] = [
  { id: 'vue', type: 'code', fileName: 'App.vue', fileExtension: '.vue', code: '' },
  { id: 'composable', type: 'code', fileName: 'useUser.ts', fileExtension: '.ts', code: '' },
  { id: 'css', type: 'code', fileName: 'app.css', fileExtension: '.css', code: '' },
  { id: 'spec', type: 'code', fileName: 'App.spec.ts', fileExtension: '.ts', code: '' },
...
export const ManyTabs: Story = { args: { tabs: manyTabs, activeTabId: 'vue', theme: 'dark' } };
