...
import CodeBlockStoryWrapper from './CodeBlockStoryWrapper.vue';
...
const meta: Meta<typeof CodeBlockStoryWrapper> = {
  ...
  render: (args) => ({
    components: { CodeBlockStoryWrapper },
    setup() { return { args }; },
    template: `<CodeBlockStoryWrapper v-bind="args" />`,
  }),
  parameters: { layout: 'padded' },
};

export default meta;
type Story = StoryObj<typeof CodeBlockStoryWrapper>;
