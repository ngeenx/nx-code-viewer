<template>
  <div class="page-container" :class="theme">
    ...
    <div class="demo-section" v-for="example in diffExamples" :key="example.title">
    ...
    <div class="demo-section">
      <h2 class="demo-section-title">Long Diff with Fixed Height</h2>
      <p class="demo-section-description">
        A larger diff example with <code>maxHeight="400px"</code> to demonstrate scrollable diff content.
      </p>
      <div class="demo-controls">
        <button
          class="demo-toggle-btn"
      ...
      <DiffViewer
        :oldCode="longDiffExample.oldCode"
        :newCode="longDiffExample.newCode"
        :language="longDiffExample.language"
        :theme="theme"
        :shikiTheme="getResolvedShikiTheme()"
        :viewMode="diffViewMode"
...
import type { CodeViewerLanguage, DiffViewMode, DiffCollapsedLinesInput } from '@ngeenx/nx-vue-code-viewer';
import { useTheme } from '../composables/useTheme';

const { theme, getResolvedShikiTheme } = useTheme();

const diffViewMode = ref<DiffViewMode>('unified');
